...
class LLM:
    ...
    def __init__(
        ...
        *,
        ...
        compression_scorer_options: dict[str, str] | None = None,
        ...
        **kwargs: Any,
        ...
        engine_args = EngineArgs(
            ...
            compression_evict_current_chunk=compression_evict_current_chunk,
            compression_slot_score_source=compression_slot_score_source,
            compression_scorer_options=compression_scorer_options or {},
            ...
            compression_budget_scope=compression_budget_scope,
